...
export default function LearnMore() {
  ...
  //   try {
  //     const response = await axios.get(`https://api-fns.ru/api/egr?req=${inn}&key=79933b33`);
  //     console.log(response)
  //     const { data } = response;
  //     const companyName = data.items[0].namerus || '';
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:3001/send-email', { to, companyName, firstName, subject, text, phoneNumber, comment, inn, email })
